...
// let menuClosed = burger.style.display="block", menue.style.display="none", herO.style.display="block";
...
let konTrigger = document.querySelectorAll("#dropdown-trigger");
    ...
    document.addEventListener("click", function(event){
            ...
            let btnSect= document.getElementsByClassName(".dropdown-btns")
            for(let i = 0; i < btnSect.length; ++i){
                if ((event).target === btnSect[0]){
                    resetMenu();
                    console.log("bbby")
                }
