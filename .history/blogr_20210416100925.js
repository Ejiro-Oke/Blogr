    ...
    for (let i = 0; i < k.length; ++i);{
        konTrigger[0].addEventListener("click", function(){
             ...
             for (let i = 0; i < koN.length; ++i);{
                        if (koN[0].style.display !== "block"){
                            koN[0].style.display = "block"
                        }
                        else{
                ...
                konTrigger[1].addEventListener("click", function(){
                        if (koN[1].style.display !== "block"){
                            koN[1].style.display = "block";
                        }
                        else{
                ...
                konTrigger[2].addEventListener("click", function(){
                    console.log("clickec")
                        if (koN[2].style.display !== "block"){
                            koN[2].style.display = "block";
                        }
                        else{
