...
//for onhoverEvent
 ...
 let rowRow = document.getElementsByClassName("arrow");
 for(let i = 0; i < rowRow.length; ++i){
    //  console.log(rowRow[i])

     rowRow[i].addEventListener('mouseover', function(){
        console.log('clicked');
    ...
    rowRow[i].addEventListener('mouseout', function(){
        console.log('i dey');
        if(content[i].style.display === 'block'){
            content[i].style.display= 'none';
            rowRow[i].style.transform = 'rotate(0deg)';
    ...
    let dropTrigger= document.querySelectorAll;
    for (let i = 0; i < dropTrigger.length)
    rowRow[i].addEventListener('click', function(){
        // console.log('clicked');
        if(content[i].style.display !== 'block'){
            content[i].style.display= 'block';
            rowRow[i].style.transform = 'rotate(180deg)';
